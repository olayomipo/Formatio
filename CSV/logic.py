...
class CSV():
    ...
    Purpose:
        Class containing function which converts CSV files.
        
    Function:
       __ to xls __ : This converts the CSV file to XLSX (Excel).
       __ to_csv __ : This converts the CSV file to CSV (Comma Seperated File).
       __ to_json __: This converts the CSV file to JSON (JavaScript Oriented Notation).
       __ to_xml __ : This converts the CSV file to XML.
       __ to_sql __ : This converts the CSV file to SQL (Structured Query Language).
       __ to_html __: This converts the CSV file to HTML (HyperText Markup Language).
       
       YET TO BE INITIALIZED:
       __ to_pdf __ : This convert the CSV file to PDF.
       __ to_pptx __: This convert the CSV file to PPTx (Powerpoint file).
    ...
    def xls_to_df(self):
        ...
        return  pd.DataFrame(pd.read_csv(self.input_file)) 
    ...
    def __init__(self, input_file, file_to):
        try: 
            ...
            self.default_file = f'{file_to}/file_{CSV.counter}_{date_string()}'
