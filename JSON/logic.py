...
class JSON():
    ...
    Purpose:
        Class containing function which converts JSON files.
        
    Function:
       __ to xls __ : This converts the JSON file to XLSX (Excel).
       __ to_csv __ : This converts the JSON file to CSV (Comma Seperated File).
       __ to_json __: This converts the JSON file to JSON (JavaScript Oriented Notation).
       __ to_xml __ : This converts the JSON file to XML.
       __ to_sql __ : This converts the JSON file to SQL (Structured Query Language).
       __ to_html __: This converts the JSON file to HTML (HyperText Markup Language).
       
       YET TO BE INITIALIZED:
       __ to_pdf __ : This convert the JSON file to PDF.
       __ to_pptx __: This convert the JSON file to PPTx (Powerpoint file).
    ...
    def xls_to_df(self):
        ...
        return  pd.DataFrame(pd.read_json(self.input_file)) 
    ...
    def __init__(self, input_file, file_to):
        try: 
            ...
            self.default_file = f'{file_to}/file_{JSON.counter}_{date_string()}'
